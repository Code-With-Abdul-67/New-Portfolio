      ...
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6 mb-6">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <p className="text-lg font-bold gradient-text">Code-With-Abdul</p>
          ...
          >
            {footerLinks.map((link) => (
              <button
                ...
                className="text-purple-400/60 hover:text-purple-300 transition-colors text-sm bg-transparent border-0 cursor-pointer"
              >
                {link.label}
              </button>
            ))}
        ...
        <div className="border-t border-violet-500/10 pt-6 text-center">
